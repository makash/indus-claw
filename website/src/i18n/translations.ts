...
export const translations: Partial<Record<Lang, TranslationSet>> & { en: TranslationSet } = {
  en: {
    ...
    hero: {
      ...
      subtitle: 'Built on Indian LLMs. Not bolted onto Western ones.',
      description: 'OpenClaw has 60K+ stars and proved open-source AI agents work. But it runs on Claude, GPT, and DeepSeek. You speak Hindi, Tamil, Telugu, Bengali — your AI should too. IndusClaw is the fork that puts Indian language models first.',
    },
    about: {
      title: 'The Problem',
      description: 'India now has Sarvam-105B with 128K context across 22 languages. Krutrim-2 doing fast inference at 12B parameters. Hanooman generating video. But every AI agent platform still defaults to Western models. Your languages are an afterthought. IndusClaw changes that.',
      features: [
        'Talk to your AI in Hindi, Tamil, or any of 22 scheduled languages — natively, not through a translation layer',
        'Run Sarvam, Krutrim, or Hanooman as your default model — not a fallback buried in a config file',
        'Use it on WhatsApp — voice-first, because that\'s how hundreds of millions of Indians actually communicate',
        'Self-host everything on Indian infrastructure. Your data never leaves the country unless you want it to',
        'Plug in any LLM. Start with Indian models, add OpenAI or Anthropic when you need them. Your choice',
        'Fork it, extend it, ship it. MIT licensed, fully open source, no strings attached',
      ],
    },
    llms: {
      title: 'Indian LLMs Ready for Your Agent',
      subtitle: 'These aren\'t research toys. They\'re production models from IITs, government labs, and well-funded startups. Pick the one that fits your use case.',
      headers: {
        model: 'Model',
        org: 'Organization',
        params: 'Parameters',
      ...
      disclaimer: 'No model locked in yet. IndusClaw is model-agnostic — you choose what runs under the hood.',
    },
    cta: {
      title: 'Get in Early',
      subtitle: 'The fork is coming. Drop your email and you\'ll hear from us before anyone else.',
      placeholder: 'your@email.com',
      button: 'Notify Me',
      privacy: 'One email when it launches. No spam.',
      success: 'You\'re in. We\'ll reach out when the fork drops.',
    },
    footer: {
