...
export const translations: Partial<Record<Lang, TranslationSet>> & { en: TranslationSet } = {
  en: {
    ...
    hero: {
      badge: 'Open Source · Looking for Contributors',
      title: 'Your AI Agent Should Speak',
      titleHighlight: 'All 22 of Your Languages',
      subtitle: 'An OpenClaw fork. Powered entirely by Indian LLMs.',
      description: 'OpenClaw has 60K+ stars and proved open-source AI agents work. But it runs on Claude, GPT, and DeepSeek. India now has production-grade LLMs that cover 22 languages. Someone needs to fork OpenClaw and build it on top of those. That\'s what IndusClaw is for.',
    },
    about: {
      title: 'Why This Needs to Exist',
      description: 'Sarvam-105B has 128K context across 22 languages. Krutrim-2 does fast inference at 12B parameters. Hanooman generates video. AI4Bharat\'s IndicTrans2 translates across every scheduled language. The models are here. What\'s missing is an AI agent platform that treats them as first-class citizens.',
      features: [
        'An AI agent you can talk to in Hindi, Tamil, or any of 22 scheduled languages — natively, not through a translation layer',
        'Indian LLMs as the default model — Sarvam, Krutrim, or Hanooman out of the box, not a fallback buried in a config file',
        'Voice-first interaction on WhatsApp — because that\'s how hundreds of millions of Indians actually communicate',
        'Self-hostable on Indian infrastructure — your data never leaves the country unless you want it to',
        'Model-agnostic under the hood — start with Indian LLMs, plug in others when you need them',
        'Fully open source, MIT licensed — fork it, extend it, make it yours',
      ],
    },
    llms: {
      title: 'Indian LLMs We Want to Power This',
      subtitle: 'These aren\'t research toys. They\'re production models from IITs, government labs, and well-funded startups. The foundation is here — the agent platform on top is what we need to build.',
      headers: {
        model: 'Model',
        org: 'Organization',
        params: 'Parameters',
      ...
      disclaimer: 'No model locked in yet. IndusClaw will be model-agnostic — the community decides what runs under the hood.',
    },
    cta: {
      title: 'Help Build This',
      subtitle: 'This is day zero. No fork exists yet. We need developers, translators, and Indian LLM builders who want to make this real. Leave your email — we\'ll reach out when it\'s time to ship.',
      placeholder: 'your@email.com',
      button: 'Count Me In',
      privacy: 'One email when we\'re ready to build. No spam.',
      success: 'You\'re in. We\'ll reach out when it\'s time.',
    },
    footer: {
      tagline: 'Open-source AI agents that speak your language.',
      built: 'Built by',
